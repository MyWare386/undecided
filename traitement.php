...
if(isset($_POST['submit'])){
  ...
  if(!empty($_POST['choice1']) and !empty($_POST['choice2'])){
    ...
    if(!empty($_POST['text1b1']) or !empty($_POST['text1b2']) or !empty($_POST['text1b3'])){
      ...
      if(!empty($_POST['points1b1']) or !empty($_POST['points1b2']) or !empty($_POST['points1b3'])){

        if(!empty($_POST['text1d1']) or !empty($_POST['text1d2']) or !empty($_POST['text1d3'])){

          if(!empty($_POST['points1d1']) or !empty($_POST['points1d2']) or !empty($_POST['points1d3'])){

            if(!empty($_POST['text2b1']) or !empty($_POST['text2b2']) or !empty($_POST['text2b3'])){

              if(!empty($_POST['points2b1']) or !empty($_POST['points2b2']) or !empty($_POST['points2b3'])){

                if(!empty($_POST['text2d1']) or !empty($_POST['text2d2']) or !empty($_POST['text2d3'])){

                  if(!empty($_POST['points2d1']) or !empty($_POST['points2d2']) or !empty($_POST['points2d3'])){
                    ...
                    echo '<i><p style="font-size:15px;color:red">You must fill at least 1 benefit and <br />1 disadvantage for each option.</p></i>';
                  };
    ...
    echo '<i><p style="font-size:15px;color:red;">You have to choose options.</p></i>';
  };
